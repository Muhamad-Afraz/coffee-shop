...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "FAIR enough Coffee" },
      { property: "og:title", content: "FAIR enough — Specialty Coffee, Riyadh" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Inter:wght@300;400;500;600&family=Amiri:wght@400;700&display=swap",
      },
    ],
  }),
